...
was checked against. If it touches the TUI, say what you actually looked at
in a real terminal: rendering bugs of the kind that have shipped here twice
were invisible to the synthetic-fixture tests.
-->
