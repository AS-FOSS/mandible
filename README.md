...
- Real fuzzy search (`mantui-search`, backed by `nucleo`): commands and
...
- `mantui --doctor <tool>` (non-interactive diagnostic) and
...
The honest coverage story: mantui is genuinely useful today for the ~740
